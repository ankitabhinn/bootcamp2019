...
public class TeamDaoImpl  implements  TeamDao {
	...
	public Object getTeams() {
		...
		try {
		teamList = jdbcTemplate.query(" select TID,TNAME,CREATION_DATE from TEAM", new RowMapper<Team>() {
			public Team mapRow(ResultSet rs, int rowNum) throws SQLException {
				Team team = new Team(); 
				team.setId(rs.getInt("TID"));
				team.setTname(rs.getString("TNAME"));
				team.setCdate(rs.getString("CREATION_DATE"));
				return team;
			}
